...
def GenerateXML(filename):
   ...
   #----start SttlmTmIndctn
    ...
    amtVal = root.createTextNode('10.00')
    ...
    instdagt = root.createElement('InstdAgt')
    cdttrftxinf.appendChild(instgagt)
    fininstnid = root.createElement('FinInstnId')
    ...
    idVal = root.createTextNode("DBTRAGNTOTHR" + str(randomizer.randomizer(digits, 22)))
    id.appendChild(idVal)
    ...
    #---- finish cdtr
    #---- start cdtrAcct
    cdtracct = root.createElement('CdtrAcct')
    ...
    idVal = root.createTextNode("BENEFICIARY" + str(randomizer.randomizer(digits, 22)))
    id.appendChild(idVal)
